class englishText {
    ...
    textId11 = "Our team is made up of people with working experience in GIS, photogrammetry, and LiDAR technology. We always strive to stay up to date with new technologies and work together to provide our clients with the best possible solutions.";
    ...
    textId19 = "We specialize in photogrammetry, enabling precise imaging and mapping of large areas, which is particularly beneficial for topographic and surveying projects. This technology allows rapid and efficient spatial data collection on the field, optimizing time and cost for our clients.";
    textId20 = "LiDAR";
    ...
    textId33 = "LiDAR point cloud conversion to 2D/3D site plans";
    textId34 = "- Point cloud digitization.<br>- Processing point cloud to extract necessary elements for producing topography model.<br>- Creating site plan in required software (AutoCAD, Civil3D, ArcGIS, QGIS).<br>- Preparing layouts in different formats appropriate for desired form of data presentation (PDF documents, web map etc.).";
    ...
    textId40 = "- Planning flight mission and conducting drone flight over the area in order to collect images for 3D model creation.<br>- Measuring GCPs and check points using GPS device in order to correctly georeference 3D model and ensure it's accuracy.<br>- Processing collected data and creating 3D model, beside other necessary deliverables such as orthophoto, digital elevation or surface model and contour lines.<br>- Overlaying exported deliverables with other spatial data sources (cadastre data, zoning etc.) which contributes in decision making process.";
    textId48 = "GIS";
